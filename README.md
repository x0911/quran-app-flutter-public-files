...
| :--- | :--- | :--- | :--- |
| `v3.0.0` | `hafs_bundle.tar.xz` | 33.03 MB | 11 |
| `v3.0.0` | `quran_offline_library.tar.xz` | 21.18 MB | 9 |
...
**Total Asset Downloads across all releases:** `89`

*Last updated: 2026-09-10 02:01 UTC*
<!-- DOWNLOAD_STATS_END -->
