...
| :--- | :--- | :--- | :--- |
| `v3.0.0` | `hafs_bundle.tar.xz` | 33.03 MB | 5 |
| `v3.0.0` | `quran_offline_library.tar.xz` | 21.18 MB | 6 |
...
**Total Asset Downloads across all releases:** `80`

*Last updated: 2026-09-09 02:05 UTC*
<!-- DOWNLOAD_STATS_END -->
